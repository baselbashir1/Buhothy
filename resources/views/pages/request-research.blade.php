            ...
            <div id="requestDiv">
                ...
                <div class="row mb-2">
                    ...
                    <div class="col-xs-12 col-md-4 mb-2">
                        ...
                        @error('phone')
                            <p class="m-2 text-red-600 phone-validation" style="color: red">{{ $message }}</p>
                        @enderror
                    </div>
                    <div class="col-xs-12 col-md-4">
                        <label for="email" class="form-label">{{ __('trans.email') }}</label>
                        <input type="email" name="email" class="form-control text-left" id="email"
                            placeholder="{{ __('trans.email_placeholder') }}">
                        <p class="text-red-600 mt-2 error-validation" style="color: red" id="email-error"></p>
                        @error('email')
                            <p class="m-2 text-red-600 email-validation" style="color: red">{{ $message }}</p>
                        @enderror
                    </div>
                </div>
        ...
        <script>
            $(document).ready(function() {
                ...
                $('#research_papers_count').on('input', function() {
                    ...
                    } else if ($('#education_level').val() === 'Middle School') {
                    ...
                    } else if ($('#education_level').val() === 'High School') {
                        if (parseInt(countValue, 10) === 0) {
                            priceAmount = 0;
                            $('#potential-price').text('');
                            $('#research_papers_count-error').text(
                    ...
                    } else if ($('#education_level').val() === 'University') {
                        if (parseInt(countValue, 10) === 0) {
                            priceAmount = 0;
                            $('#potential-price').text('');
                            $('#research_papers_count-error').text(
                    ...
                    } else if ($('#education_level').val() === 'Graduate Studies') {
                        if (parseInt(countValue, 10) === 0) {
                            priceAmount = 0;
                            $('#potential-price').text('');
                            $('#research_papers_count-error').text(
